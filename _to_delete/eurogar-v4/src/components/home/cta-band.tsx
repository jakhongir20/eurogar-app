  ...
  return (
    <section className="dark-section relative overflow-hidden bg-ink-900 py-16 text-white md:py-24">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(60rem 30rem at 80% 20%, rgba(41,171,226,.13), transparent 65%)",
        }}
      />
      {/* nozik yuqori chiziq */}
      <div className="absolute inset-x-0 top-0 h-px bg-[linear-gradient(90deg,transparent,rgba(41,171,226,.5),transparent)]" />
        ...
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
          ...
          <Reveal delay={0.1} dir="left">
            <div className="glass-dark rounded-[1.75rem] p-5 md:p-7">
              ...
              <p className="mt-4 text-center text-[12px] leading-relaxed text-white/60">
                {t("successNote")}
              </p>
            </div>
          </Reveal>
