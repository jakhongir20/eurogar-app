...
const variants: Record<Variant, string> = {
  primary:
    "bg-brand-400 text-ink-950 shadow-[0_10px_30px_-10px_rgba(41,171,226,.75)] hover:shadow-[0_18px_44px_-12px_rgba(41,171,226,.9)] hover:-translate-y-0.5",
  dark: "bg-ink-900 text-white hover:bg-ink-800 shadow-[0_10px_30px_-12px_rgba(4,34,47,.6)] hover:-translate-y-0.5",
  light:
    "bg-white text-graphite border border-bone-300 hover:border-graphite/25 shadow-[0_2px_10px_-4px_rgba(13,36,48,.15)] hover:-translate-y-0.5",
  outline:
