...
export default function NotFound() {
  ...
  return (
    <section className="dark-section relative flex min-h-[80vh] items-center overflow-hidden bg-ink-950 text-white">
      <div className="grid-texture pointer-events-none absolute inset-0 opacity-70" />
      <div
        className="pointer-events-none absolute top-1/3 left-1/2 size-[34rem] -translate-x-1/2 rounded-full opacity-[0.14] blur-[110px]"
        style={{
          background:
