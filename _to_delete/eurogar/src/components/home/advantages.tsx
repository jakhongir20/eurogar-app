            ...
            return (
              <RevealItem key={item.title}>
                <motion.div
                  ...
                  className="group relative h-full overflow-hidden rounded-3xl border border-bone-300 bg-white p-6 transition-shadow duration-500 hover:shadow-[0_28px_60px_-30px_rgba(20,24,31,.3)] md:p-7"
                >
                  {/* fon raqami */}
                  <span className="font-display pointer-events-none absolute -top-5 -right-2 text-[6rem] leading-none font-black text-bone-200 transition-colors duration-500 group-hover:text-brand-200/50">
                    0{i + 1}
                  </span>
