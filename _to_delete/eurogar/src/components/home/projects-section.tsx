...
export function ProjectsSection() {
  ...
  return (
    <Section tone="dark" id="projects" className="overflow-hidden">
      <div className="grid-texture pointer-events-none absolute inset-0 opacity-70" />
      <div
        className="pointer-events-none absolute top-1/4 -left-32 size-[32rem] rounded-full opacity-[0.11] blur-[120px]"
        style={{
          background:
        ...
        <SectionHeading
          ...
          action={
            <div className="text-right">
              <div className="font-display text-[clamp(2.4rem,6vw,3.6rem)] leading-none font-black text-brand-400">
          ...
          {projects.map((p, i) => (
            ...
            >
              <button
                ...
                className="group/pr relative block h-full w-full overflow-hidden rounded-3xl border border-white/10 bg-ink-850 text-left transition-all duration-500 hover:border-brand-400/40"
              >
                <div
                  className={cn(
                ...
                >
                  ...
                  />
                  <span className="pointer-events-none absolute inset-0 bg-[linear-gradient(to_top,rgba(6,8,11,.92),rgba(6,8,11,.25)_55%,transparent)]" />
        ...
        {active && (
          ...
          >
            ...
            <motion.div
              ...
              className="relative w-full max-w-4xl overflow-hidden rounded-3xl border border-white/12 bg-ink-900"
            >
              <button
                onClick={() => setActive(null)}
              ...
              <div className="p-6 md:p-8">
                <div className="flex items-center gap-3 text-[12.5px] font-semibold text-brand-400">
                  ...
                  <span className="size-1 rounded-full bg-white/25" />
                  <span className="text-white/50">{active.year}</span>
                </div>
