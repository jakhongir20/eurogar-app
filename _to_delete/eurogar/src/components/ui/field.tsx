    ...
    <div className={cn("w-full", className)}>
      ...
      {error ? (
        ...
        <p
          className={cn(
            "mt-1.5 text-[12.5px]",
            tone === "dark" ? "text-white/45" : "text-muted/80",
          )}
        >
          {hint}
        </p>
...
const control = (tone: Tone, invalid?: boolean) =>
  cn(
    ...
    tone === "dark"
      ? "bg-white/[0.055] text-white border border-white/12 focus:border-brand-400/70 focus:bg-white/[0.09] focus:shadow-[0_0_0_4px_rgba(245,181,68,.13)]"
      : "bg-white text-graphite border border-bone-300 focus:border-brand-400 focus:shadow-[0_0_0_4px_rgba(245,181,68,.16)]",
    invalid &&
