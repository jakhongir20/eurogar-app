              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    active
                      ? "border-brand-400 bg-brand-200/25 shadow-[0_10px_26px_-14px_rgba(245,181,68,.9)]"
      ...
      <aside className="lg:col-span-2">
        <div className="dark-section relative overflow-hidden rounded-[2rem] bg-ink-900 p-6 text-white lg:sticky lg:top-28 md:p-7">
          ...
          <div className="relative">
            ...
            <div className="mt-6">
              <div className="text-[12px] font-bold tracking-[0.16em] text-white/40 uppercase">
                {tcalc("estimate")}
              </div>
            ...
            <p className="mt-5 flex items-start gap-2 rounded-2xl bg-white/[0.055] p-3.5 text-[12.5px] leading-relaxed text-white/50">
