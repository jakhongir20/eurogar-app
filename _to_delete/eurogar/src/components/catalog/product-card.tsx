  ...
  return (
    <motion.article
      ...
      className={cn(
        ...
        "shadow-[0_1px_2px_rgba(20,24,31,.05)] transition-shadow duration-500",
        "hover:border-bone-400 hover:shadow-[0_28px_60px_-28px_rgba(20,24,31,.28)]",
        className,
      )}
    >
      {/* rasm */}
      ...
      >
        ...
        <span className="pointer-events-none absolute inset-0 bg-[linear-gradient(to_top,rgba(11,14,19,.16),transparent_45%)] opacity-0 transition-opacity duration-500 group-hover/card:opacity-100" />
      ...
      <button
        ...
        className={cn(
          ...
          "shadow-[0_12px_28px_-10px_rgba(11,14,19,.6)] active:scale-90",
