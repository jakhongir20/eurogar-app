    ...
    >
      ...
      <div className="relative mb-4">
        ...
        <input
          ...
          className="h-13 w-full rounded-2xl border border-bone-300 bg-white pr-4 pl-11 text-[14.5px] text-graphite outline-none transition-all focus:border-brand-400 focus:shadow-[0_0_0_4px_rgba(245,181,68,.16)]"
        />
      </div>
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative w-full max-w-3xl rounded-[1.75rem] bg-bone-100 shadow-[0_40px_100px_-30px_rgba(6,8,11,.6)]"
      >
