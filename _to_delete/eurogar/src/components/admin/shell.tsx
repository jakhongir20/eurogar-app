        ...
        return (
          <Link
            ...
            className={cn(
              ...
              active
                ? "bg-brand-400 text-ink-950 shadow-[0_8px_22px_-12px_rgba(245,181,68,.9)]"
      ...
      <aside className="dark-section sticky top-0 hidden h-dvh w-64 shrink-0 flex-col bg-ink-950 p-4 lg:flex">
        ...
        <div className="space-y-1 border-t border-white/8 pt-3">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex items-center gap-3 rounded-xl px-3.5 py-3 text-[14px] font-semibold text-white/45 transition-colors hover:bg-white/8 hover:text-white"
          >
          ...
          <button
            onClick={logout}
            className="flex w-full items-center gap-3 rounded-xl px-3.5 py-3 text-[14px] font-semibold text-white/45 transition-colors hover:bg-red-500/15 hover:text-red-400"
          >
      ...
      {open && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <aside className="dark-section absolute top-0 left-0 flex h-full w-72 flex-col bg-ink-950 p-4">
            ...
            <button
              onClick={logout}
              className="flex items-center gap-3 rounded-xl px-3.5 py-3 text-[14px] font-semibold text-white/45 hover:text-red-400"
            >
              <LogOut className="size-[18px]" strokeWidth={2.2} />
              Chiqish
            </button>
