  ...
  return (
    ...
    >
      <button
        aria-label={tc("back")}
        onClick={onClose}
        className="absolute inset-0 cursor-default bg-ink-950/72 backdrop-blur-md"
      />
      ...
      >
        <div className="overflow-hidden rounded-3xl border border-bone-300 bg-bone-100 shadow-[0_40px_100px_-30px_rgba(6,8,11,.7)]">
          {/* input */}
