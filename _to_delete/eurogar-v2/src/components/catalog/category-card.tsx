    ...
    >
      <Link
        ...
        className={cn(
          ...
          "hover:shadow-[0_30px_64px_-30px_rgba(13,36,48,.34)]",
        )}
      >
        <div
          className={cn(
        ...
        >
          ...
          />
          <span className="pointer-events-none absolute inset-0 bg-[linear-gradient(to_top,rgba(4,34,47,.55),transparent_52%)] opacity-0 transition-opacity duration-600 group-hover/cat:opacity-100" />
